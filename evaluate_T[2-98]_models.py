...
model_IDs_csv   = '/home/gino/projects/4D_MRI_CNN/experiments/transfer_learning_experiments/models_T[2-98].csv'
...
if __name__ == '__main__':
    ...
    for m_num, model_ID in enumerate(model_IDs): 
        ...
        csv_name = os.path.join(out_path, 'losses_tmp', 'masked_losses_T[2-98]_smpl-{}_prt-{}.csv'.format(int(sampling*100), utils.number_zeroPadding_3(m_num+1)))
