...
model_IDs_csv   = '/home/gino/projects/4D_MRI_CNN/experiments/transfer_learning_experiments/all_T[5-50]_models.csv'
...
if __name__ == '__main__':
    ...
    for ID in IDs: 
        ...
        print('validation data loss for model with ID: {} = {}'.format(ID, loss))
    ...
    csv_name = os.path.join(out_path, 'losses_T[5-50].csv')
    with open(csv_name, 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
        csvwriter.writerow(['ID', 'target_case', 'target_train_size', 'target_loss', 'model_name'])
